...
namespace FileHydra.NetworkEnums
{
    ...
    public sealed class NetworkBrowser
    {
        ...
        uint SV_TYPE_WORKSTATION = 1;
        uint SV_TYPE_SERVER = 2;
        uint SV_TYPE_DOMAIN = 0x80000000;
        uint SV_TYPE_ALL = 0xFFFFFFFF;
        ...
        {
            return getNetworkComputers(SV_TYPE_DOMAIN,null);
        }

        public List<string> GetNetworkComputers(string domain)
        {
            return getNetworkComputers(SV_TYPE_SERVER | SV_TYPE_WORKSTATION | SV_TYPE_ALL, domain);
        }
